A collection of required files to deploy with a node application on Azure, and some Gulp tasks for copying these files into your `dist` folder prior to deployment.
